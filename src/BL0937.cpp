...
Copyright (C) 2018 by Mustafa 'gn0st1c' Tufan
    based on code from; Copyright (C) 2016 by Xose Pérez <xose dot perez at gmail dot com>
...
// 1000000.0 *
    ...
    _power_multiplier   = 1721506 / (_voltage_resistor / _current_resistor * (V_REF * V_REF));
    _voltage_multiplier = 15397 / (_voltage_resistor * V_REF);
    _current_multiplier = 94638 / (_current_resistor * V_REF);
}
